...
class Window(QMainWindow):
    ...
    def initUI(self):
        ...
        #-------------------------------------------------------------------------------------------------------
        self.btn_create_csv_dataset = QPushButton('Сгенерировать ключи', self)
        ...
        self.btn_create_csv_dataset.clicked.connect(self.gen_keys)
        #-------------------------------------------------------------------------------------------------------
        self.btn_copy_dataset_name = QPushButton('Зашифровать текст', self)
        ...
        self.btn_copy_dataset_name.clicked.connect(self.text_encryption)
        #-------------------------------------------------------------------------------------------------------
        self.btn_copy_dataset_random_name = QPushButton('Дешифровать текст', self)
        ...
        self.btn_copy_dataset_random_name.clicked.connect(self.text_decryption)
